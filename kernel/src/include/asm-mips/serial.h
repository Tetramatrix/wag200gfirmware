...
#ifdef CONFIG_MIPS_SEAD2
#define TI_AUTOFLOW_ENABLE  0x20   /* This is a TI UART specific bit */
#include <asm/mips-boards/sead.h>
#define SEAD2_SERIAL_PORT_DEFNS  \
          { 0, SEAD_BASE_BAUD, SEAD_UART0_REGS_BASE, SEADINT_UART0, STD_COM_FLAGS }, \
          { 0, SEAD_BASE_BAUD, SEAD_UART1_REGS_BASE, SEADINT_UART1, STD_COM_FLAGS },  
#else /* !CONFIG_MIPS_SEAD2 */
#define SEAD2_SERIAL_PORT_DEFNS
#endif



#ifdef CONFIG_AVALANCHE_SERIAL
#define TI_AUTOFLOW_ENABLE  0x20   /* This is a TI UART specific bit */
#include <asm/avalanche/generic/pal.h>
#ifdef CONFIG_AVALANCHE_UART1_TTYS0
/* UART 1 (h/w flow) = ttyS0 */
#ifdef CONFIG_AVALANCHE_SERIAL_SINGLE_PORT
...
#endif
#else /* !CONFIG_AVALANCHE_UART1_TTYS0 */
/* UART 0 (no h/w flow)= ttyS0 */
#ifdef CONFIG_AVALANCHE_SERIAL_SINGLE_PORT
#define AVALANCHE_SERIAL_PORT_DEFNS  \
          { 0, AVALANCHE_BASE_BAUD, AVALANCHE_UART0_REGS_BASE, LNXINTNUM(AVALANCHE_UART0_INT), STD_COM_FLAGS },
#else
#define AVALANCHE_SERIAL_PORT_DEFNS  \
          ...
          { 0, AVALANCHE_BASE_BAUD, AVALANCHE_UART1_REGS_BASE, LNXINTNUM(AVALANCHE_UART1_INT), STD_COM_FLAGS }, 
#endif
#endif /* CONFIG_AVALANCHE_UART1_TTYS0 */
#else /* !CONFIG_AVALANCHE_SERIAL */
#define AVALANCHE_SERIAL_PORT_DEFNS
