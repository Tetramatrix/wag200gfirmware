...
#define jiffies (volatile unsigned long)(((volatile unsigned long *)&jiffies_64)[0])
#else
#define jiffies (volatile unsigned long)(((volatile unsigned long *)&jiffies_64)[1])
#endif
