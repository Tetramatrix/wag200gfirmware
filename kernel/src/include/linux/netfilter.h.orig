...
/* TI Optimizations: The 'list_empty' check is not valid, because we do not
 * dynamically unload the firewall modules anymore. Instead use the global
 * variable to determine if we need to goto the hook or not. */
#ifndef TI_SLOW_PATH
/* The variable determines the state of the firewall/connection tracking
 * modules. */
