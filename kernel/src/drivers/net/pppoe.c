...
int __pppoe_xmit(struct sock *sk, struct sk_buff *skb)
{
    ...
    /* Do not initialize the network header for QOS U32 classifier. This is a common
     * function shared by the control and data paths. The network header should be
