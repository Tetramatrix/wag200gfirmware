...
#if defined(CONFIG_MIPS_AR7WRD) || defined(CONFIG_MIPS_AR7WI) || defined(CONFIG_MIPS_AR7VWI)|| defined(CONFIG_MIPS_AR7VW) || defined(CONFIG_CPMAC_WAN_LAN)
...
#define MARVELL_WAN_HEADER_MASK          0x2002
#define MARVELL_LAN_HEADER_MASK          0x101C
#define INGRESS_HEADER_LEN 				2
#define MARVELL_EGRESS_HEADER_LEN		2

/* Adding 2 bytes for ingress header and two more to keep the alignment of the data */
#define CPMAC_MAX_FRAME_SIZE          (1518 + INGRESS_HEADER_LEN + 2) 
#else
...
#define CPMAC_LINK_OFF_10          10
#define CPMAC_LINK_ON_10           11
#define CPMAC_RX_ACTIVITY_10       12
#define CPMAC_TX_ACTIVITY_10       13
#endif
//rick, 041230, Modify LED for netgear }
...
/* frank,040503 */
	...
	unsigned int 				 vlan_trailer;
	unsigned int				 vlan_group[4];
#endif	
