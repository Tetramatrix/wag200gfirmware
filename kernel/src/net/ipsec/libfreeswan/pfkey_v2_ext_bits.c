 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_ext_bits.c,v 1.1.1.1 2006-01-16 08:12:15 jeff Exp $
 */
...
char pfkey_v2_ext_bits_c_version[] = "$Id: pfkey_v2_ext_bits.c,v 1.1.1.1 2006-01-16 08:12:15 jeff Exp $";
