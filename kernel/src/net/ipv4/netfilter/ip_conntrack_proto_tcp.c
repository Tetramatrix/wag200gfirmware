...
= { 30 MINS, 	/*	TCP_CONNTRACK_NONE,	*/
    7 MINS,	/*	TCP_CONNTRACK_ESTABLISHED,	*/
...
/* Don't support simultaneous TCP to fix bug of cdrouter-109 */
    if((oldtcpstate == TCP_CONNTRACK_SYN_SENT) /* old state of this tcp connection is syn-sent */
        && (CTINFO2DIR(ctinfo) == IP_CT_DIR_REPLY) /* expect to reply */
        && check_state_synonly(tcph)) /* new state of this tcp connection is also syn-sent */
    {
